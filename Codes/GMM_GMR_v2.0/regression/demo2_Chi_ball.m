...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(['Data_' ,robot, '.mat']); %load 'Data'
load(['queryData_', robot, '.mat']); %load 'queryData'
%queryData(2,:) = queryData(2,:) + 0.05;
queryData = queryData(15:17,:);
nbVar = size(Data,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
expData(15:17,:) = queryData;
[expData(1:14,:), expSigma] = GMR(Priors, Mu, Sigma,  expData(15:17,:), [15:17], [1:14]);
...
%% Plot of the data 3D by Chi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%figure('position',[10,10,1000,800],'name','GMM-GMR-demo2'); 
%subplot(3,1,1); hold on;
figure;
plot3(Data(15,1:54), Data(16,1:54), Data(17,1:54));grid on;
figure;
...
% figure;
% plot3(queryData(1,:), queryData(2,:), queryData(3,:));grid on;
% figure;
% plot3(expData(9,:), expData(10,:), expData(11,:));
% grid on;


save(['expData_', robot, '.mat'], 'expData');
pause;
close all;
